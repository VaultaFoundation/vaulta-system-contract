...
public:
   ...
   void basic_setup() {
      ...
      set_code( "eosio.token"_n, eos_contracts::token_wasm());
      set_abi( "eosio.token"_n, eos_contracts::token_abi().data() );
      {
      ...
      set_code( "eosio.bpay"_n, eos_contracts::bpay_wasm());
      set_abi( "eosio.bpay"_n, eos_contracts::bpay_abi().data() );
      {
