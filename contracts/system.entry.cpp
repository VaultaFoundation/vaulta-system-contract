...
class [[eosio::contract("system")]] system_contract : public contract {
    public:
        ...
        */
        ...
        ACTION ramburn( const name& owner, const uint64_t& bytes, const std::string& memo ){
            action(
        ...
        ACTION ramtransfer( const name& from, const name& to, const uint64_t& bytes, const std::string& memo ){
            action(
                permission_level{from, "active"_n},
                "eosio"_n,
                "ramtransfer"_n,
        ...
        ACTION sellram( const name& account, const uint64_t& bytes ){
